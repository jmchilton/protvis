...
return declare("dojox.form.uploader.FileList", [FileList], {
	templateString:	'<div class="dojoxUploaderFileList">' +
						...
						'<table class="dojoxUploaderFileListTable">'+
							'<thead><tr class="dojoxUploaderFileListHeader"><th class="dojoxUploaderDelete"><div class="dijitIconDelete dojoxUploaderDeleteRow" onclick="dijit.byId(\'${uploaderId}\').reset();">&nbsp;</div></th><th class="dojoxUploaderIndex">${headerIndex}</th><th class="dojoxUploaderIcon">${headerType}</th><th class="dojoxUploaderFileName">${headerFilename}</th><th class="dojoxUploaderFileSize" dojoAttachPoint="sizeHeader">${headerFilesize}</th></tr></thead>'+
	...
	_addRow: function(index, type, name, size){
		...
		c.innerHTML = '<div class="dijitIconDelete dojoxUploaderDeleteRow" onclick="dijit.byId(\'' + this.uploaderId + '\').removeFile(' + index + ');">&nbsp;</div>';
